...
class Golfbag:
  ...
  def player(self,hole):
    ...
    while abs(distance_remaining) > 0:
      ...
      putt = random.randint(int(distance_remaining/2),distance_remaining)
    ...
    print('{}You\'ve finished this hole with {} strokes.'.format('\033[0m',self.shot_number))
  def score(self):
...
#print(rand_dist)
def hole_list():
  hole_1 = Hole(random.randint(3,6))
  hole_2 = Hole(random.randint(3,6))
  hole_3 = Hole(random.randint(3,6))
  hole_4 = Hole(random.randint(3,6))
  hole_5 = Hole(random.randint(3,6))
  hole_6 = Hole(random.randint(3,6))
  hole_7 = Hole(random.randint(3,6))
  hole_8 = Hole(random.randint(3,6))
  hole_9 = Hole(random.randint(3,6))
  hole_10 = Hole(random.randint(3,6))
  hole_11 = Hole(random.randint(3,6))
  hole_12 = Hole(random.randint(3,6))
  hole_13 = Hole(random.randint(3,6))
  hole_14 = Hole(random.randint(3,6))
  hole_15 = Hole(random.randint(3,6))
  hole_16 = Hole(random.randint(3,6))
  hole_17 = Hole(random.randint(3,6))
  hole_18 = Hole(random.randint(3,6))
